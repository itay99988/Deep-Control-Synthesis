...
from dist_system import DistSystem, BlackboxEnvironment
...
def permitted_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('permitted', system=system, environment=environment, history_len=history_len)
...
def schedule_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('schedule', system=system, environment=environment, history_len=history_len)
...
def cases_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('cases', system=system, environment=environment, history_len=history_len)
...
def choice_scc_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('choice_scc', system=system, environment=environment, history_len=history_len)
...
def cycle_scc_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('cycle_scc', system=system, environment=environment, history_len=history_len)
...
def schedule_cycle_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('schedule_cycle', system=system, environment=environment, history_len=history_len)
...
def comb_lock_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('comb_lock', system=system, environment=environment, history_len=history_len)
...
def comb_lock2_experiment_setup(history_len=2):
    ...
    # distributed system
    dist_sys = BlackboxEnvironment('comb_lock2', system=system, environment=environment, history_len=history_len)
